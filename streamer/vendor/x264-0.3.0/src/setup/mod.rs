...
impl Setup {
    ...
    /// Maximum keyframe interval (IDR period).
    pub fn keyint_max(mut self, interval: i32) -> Self {
        self.raw.i_keyint_max = interval;
        self
    }

    /// Number of B-frames (0 = no B-frames, best for low latency).
    pub fn bframes(mut self, n: i32) -> Self {
        self.raw.i_bframe = n;
        self
    }

    /// Repeat SPS/PPS headers in every IDR frame.
    pub fn repeat_headers(mut self, val: bool) -> Self {
        self.raw.b_repeat_headers = val as i32;
        self
    }
}
